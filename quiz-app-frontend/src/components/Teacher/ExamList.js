...
// Thêm icon FaVideo cho nút giám sát
import { FaSearch, FaEye, FaPencilAlt, FaTrashAlt, FaSpinner, FaHome, FaVideo } from 'react-icons/fa';
...
const ExamList = () => {
    ...
    const handleDelete = async (examId) => {
        if (!window.confirm('Bạn có chắc chắn muốn xóa bài thi này không?')) return;
    ...
    return (
        <div className="exam-list-container">
            <div className="exam-list-header">
                <h2 className="exam-list-title">Danh sách đề thi của tôi</h2>
                                        ...
                                        <div className="exam-actions">
                                            ...
                                            {status === 'Đang diễn ra' && (
                                                <button
                                                    ...
                                                    onClick={() => navigate(`/monitor/exam/${exam._id}`)}
                                                    title="Giám sát thi trực tiếp"
                                                >
                                                    <FaVideo /> Giám sát
                                                </button>
                                            )}
